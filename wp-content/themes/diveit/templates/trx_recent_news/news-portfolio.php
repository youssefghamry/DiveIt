...
if ( !function_exists( 'diveit_template_news_portfolio_theme_setup' ) ) {
	add_action( 'diveit_action_before_init_theme', 'diveit_template_news_portfolio_theme_setup', 1 );
	function diveit_template_news_portfolio_theme_setup() {
		diveit_add_template(array(
			'layout' => 'news-portfolio',
			'template' => 'news-portfolio',
			'mode'   => 'news',
			'title'  => esc_html__('Recent News /Style Portfolio/', 'diveit'),
...
// Template output
if ( !function_exists( 'diveit_template_news_portfolio_output' ) ) {
	function diveit_template_news_portfolio_output($post_options, $post_data) {
