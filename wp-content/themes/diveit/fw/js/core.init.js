...
//Change default icon pagination in event-calendar plugin
jQuery(".post_item_single .tribe-events-nav-pagination .tribe-events-nav-previous a span").text('<');
jQuery(".post_item_single .tribe-events-nav-pagination .ribe-events-nav-next a span").text('>');