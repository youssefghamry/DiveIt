...
// Shortcode template
if ( ! class_exists( 'Diveit_VC_ShortCode' ) ) {
	abstract class Diveit_VC_ShortCode extends WPBakeryShortCode {
...
if ( ! class_exists( 'Diveit_VC_ShortCodeSingle' ) ) {
	abstract class Diveit_VC_ShortCodeSingle extends Diveit_VC_ShortCode {
	}
}

// Single shortcode without params (woocommerce_cart, checkout, etc.)
if ( ! class_exists( 'Diveit_VC_ShortCodeAlone' ) ) {
	abstract class Diveit_VC_ShortCodeAlone extends Diveit_VC_ShortCode {
		protected $controls_list = array('clone', 'delete');
	}
}

// Container shortcode (block, section, parallax)
if ( ! class_exists( 'Diveit_VC_ShortCodeContainer' ) ) {
	abstract class Diveit_VC_ShortCodeContainer extends Diveit_VC_ShortCode {
...
if ( ! class_exists( 'Diveit_VC_ShortCodeCollection' ) ) {
	abstract class Diveit_VC_ShortCodeCollection extends Diveit_VC_ShortCodeContainer {
		protected $controls_css_settings = 'out-tc vc_controls-content-widget';
		protected $controls_list = array('add', 'edit', 'clone', 'delete');
	}
}
...
if ( ! class_exists( 'Diveit_VC_ShortCodeItem' ) ) {
	abstract class Diveit_VC_ShortCodeItem extends Diveit_VC_ShortCode {
...
if ( ! class_exists( 'Diveit_VC_ShortCodeColumns' ) ) {
	abstract class Diveit_VC_ShortCodeColumns extends Diveit_VC_ShortCodeContainer {
		protected $controls_css_settings = 'out-tc vc_controls-content-widget';
		protected $controls_list = array('add', 'edit', 'clone', 'delete');
	}
}
...
if ( !class_exists('Diveit_VC_ShortCodeAccordion') ) {
	abstract class Diveit_VC_ShortCodeAccordion extends WPBakeryShortCode_VC_Accordion {}
	abstract class Diveit_VC_ShortCodeAccordionItem extends WPBakeryShortCode_VC_Accordion_tab {}
}
if ( !class_exists('Diveit_VC_ShortCodeToggles') ) {
	abstract class Diveit_VC_ShortCodeToggles extends Diveit_VC_ShortCodeAccordion {}
	abstract class Diveit_VC_ShortCodeTogglesItem extends Diveit_VC_ShortCodeAccordionItem {}
}
...
if ( ! class_exists( 'Diveit_VC_ShortCodeTabs' ) ) {
	abstract class Diveit_VC_ShortCodeTabs extends WPBakeryShortCode_VC_Tabs {
		public function setCustomTabId( $content ) {
			return preg_replace( '/tab\_id\=\"([^\"]+)\"/', 'tab_id="sc_tab_$1_' . time() . '"', $content );
		}
	}
	abstract class Diveit_VC_ShortCodeTab extends WPBakeryShortCode_VC_Tab {
	}
}
